...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=14&pause=2000&color=6B7280&center=true&vCenter=true&width=500&lines=Building+interfaces+that+look+sharp+and+feel+right.+Seeking+new+opportunities. " alt="subtitle"/>
</div>
---
<!-- ABOUT -->
```ts
const rohit = {
  ...
  focus  : ["React", "JavaScript", "UI Engineering", "Component Design", "Web Performance"],
  now    : "Building OpenSourceHub — GitHub explorer with GraphQL API",
  open   : "Frontend / UI Engineering roles (Remote)",
  location: "Remote",
};
```
---
...
<!-- LINKS -->
### ◈ Find Me
[![Portfolio](https://img.shields.io/badge/Portfolio-darkwingstudio.github.io-9333EA?style=for-the-badge&logo=googlechrome&logoColor=white)](https://darkwingstudio.github.io)
[![Instagram](https://img.shields.io/badge/Instagram-@DarkWing.in-E1306C?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/DarkWing.in)
[![X](https://img.shields.io/badge/X-@DarkWingStudio-1a1a1a?style=for-the-badge&logo=x&logoColor=white)](https://x.com/DarkWingStudio)
---
<div align="center">
<sub>DarkWing Studio · darkwingstudio.github.io</sub>
</div>
